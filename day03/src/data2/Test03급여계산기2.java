...
public class Test03급여계산기2 {
	public static void main(String[] args) {
		...
		int sPension = (int) (salary * pensionPer);
		int sHealth = (int) (salary * healthPer);
		int sCare = (int) (sHealth * carePer);
		int sEmployment = (int) (salary * employmentPer);


		
		
		int netPay = salary - sPension - sHealth - sCare - sEmployment;
