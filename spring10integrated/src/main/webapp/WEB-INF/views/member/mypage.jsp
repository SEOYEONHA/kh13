	...
	<table class="table">
		...
		<tr>
			...
			<td class="left"><fmt:formatDate
					value="${memberDto.memberLogin}" pattern="y년 M월 d일 H시 m분 s초" /></td>
		</tr>
	</table>
</div>
...
<div class="cell">
	<a href="/member/password"><button>비밀번호 변경</button></a> <a
		...
		href="/member/exit" class="link-confirm" data-message="정말 탈퇴하시겠습니까?"><button>회원
			탈퇴</button></a>
</div>

<div class="cell">
	<a href="/board/mywriting"><button>내가 쓴 글</button></a> 
	<a href="#"><button>내가 쓴 댓글</button></a>
	<a href="/member/likeList">찜목록</a>
</div>
