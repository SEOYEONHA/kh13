...
//서버에 매우 부담을 주는 위험한 기능이어서 기본적으로 금지되어있음
//main 메소드가 존재하는 파일 위에 @EnableSchedule 을 추가하여 허용 처리
@Service
...
//	@Scheduled(cron = "* * * * * *") //*초 *분 *시 *일 *월 *요일 (연도-설정 안하는 경우가 많음)
