...
//@CrossOrigin //써야하지만 아직 외부접근이 불가한 우리 홈페이지의 경우 안써도 됨
@RestController
...
//	public Map<String, Object> check(HttpSession session, @RequestParam int boardNo){
//		String loginId = (String)session.getAttribute("loginId");
//		
//		Map<String, Object> data = new HashMap<>();
//		data.put("state", boardLikeDao.check(loginId, boardNo));
//		data.put("count", boardLikeDao.check(loginId, boardNo));
//		
//		return data;
//	}
    @RequestMapping("/check")
	...
	//하트를 클릭한 경우 실행할 매핑
//	@PostMapping("/toggle")
//	public Map<String, Object> toggle(HttpSession session, @RequestParam int boardNo){
//		String loginId = (String)session.getAttribute("loginId");
//		
//		Map<String, Object> data = new HashMap<>();
//		
//		if(boardLikeDao.check(loginId, boardNo)) { //좋아요 누른 적 있으면
